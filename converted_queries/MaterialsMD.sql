CREATE OR REPLACE TABLE SSI_SAP_TO_SNOW_CLONE.REPORT.MaterialsMD
(
  Client_MANDT STRING,
  MaterialNumber_MATNR STRING,
  CreatedOn_ERSDA DATE,
  NameOfPersonWhoCreatedTheObject_ERNAM STRING,
  DateOfLastChange_LAEDA DATE,
  NameOfPersonWhoChangedObject_AENAM STRING,
  MaintenanceStatusOfCompleteMaterial_VPSTA STRING,
  MaintenanceStatus_PSTAT STRING,
  FlagMaterialForDeletionAtClientLevel_LVORM STRING,
  MaterialType_MTART STRING,
  IndustrySector_MBRSH STRING,
  MaterialGroup_MATKL STRING,
  OldMaterialNumber_BISMT STRING,
  BaseUnitOfMeasure_MEINS STRING,
  OrderUnit_BSTME STRING,
  DocumentNumber_WithoutDocumentManagementSystem_ZEINR STRING,
  DocumentType_WithoutDocumentManagementSystem_ZEIAR STRING,
  DocumentVersion_WithoutDocumentManagementSystem_ZEIVR STRING,
  PageFormatOfDocument_WithoutDocumentManagementSystem_ZEIFO STRING,
  DocumentChangeNumber_WithoutDocumentManagementSystem_AESZN STRING,
  PageNumberOfDocument_WithoutDocumentManagementSystem_BLATT STRING,
  NumberOfSheets_WithoutDocumentManagementSystem_BLANZ STRING,
  ProductioInspectionMemo_FERTH STRING,
  PageFormatOfProductionMemo_FORMT STRING,
  SizeDimensions_GROES STRING,
  BasicMaterial_WRKST STRING,
  IndustryStandardDescription_SuchAsAnsiOrIso_NORMT STRING,
  LaboratoryDesignOffice_LABOR STRING,
  PurchasingValueKey_EKWSL STRING,
  GrossWeight_BRGEW NUMERIC,
  NetWeight_NTGEW NUMERIC,
  WeightUnit_GEWEI STRING,
  Volume_VOLUM NUMERIC,
  VolumeUnit_VOLEH STRING,
  ContainerRequirements_BEHVO STRING,
  StorageConditions_RAUBE STRING,
  TemperatureConditionsIndicator_TEMPB STRING,
  LowLevelCode_DISST STRING,
  TransportationGroup_TRAGR STRING,
  HazardousMaterialNumber_STOFF STRING,
  Division_SPART STRING,
  Competitor_KUNNR STRING,
  EuropeanArticleNumber_EANNR STRING,
  Quantity_NumberOfGrgiSlipsToBePrinted_WESCH NUMERIC,
  ProcurementRule_BWVOR STRING,
  SourceOfSupply_BWSCL STRING,
  SeasonCategory_SAISO STRING,
  LabelType_ETIAR STRING,
  LabelForm_ETIFO STRING,
  Deactivated_ENTAR STRING,
  InternationalArticleNumber_Eanupc_EAN11 STRING,
  CategoryOfInternationalArticleNumber_Ean_NUMTP STRING,
  Length_LAENG NUMERIC,
  Width_BREIT NUMERIC,
  Height_HOEHE NUMERIC,
  UnitOfDimensionForLengthwidthheight_MEABM STRING,
  ProductHierarchy_PRDHA STRING,
  StockTransferNetChangeCosting_AEKLK STRING,
  CadIndicator_CADKZ STRING,
  QmInProcurementIsActive_QMPUR STRING,
  AllowedPackagingWeight_ERGEW NUMERIC,
  UnitOfWeight_AllowedPackagingWeight_ERGEI STRING,
  AllowedPackagingVolume_ERVOL NUMERIC,
  VolumeUnit_AllowedPackagingVolume_ERVOE STRING,
  ExcessWeightToleranceForHandlingUnit_GEWTO NUMERIC,
  ExcessVolumeToleranceOfTheHandlingUnit_VOLTO NUMERIC,
  VariablePurchaseOrderUnitActive_VABME STRING,
  RevisionLevelHasBeenAssignedToTheMaterial_KZREV STRING,
  ConfigurableMaterial_KZKFG STRING,
  BatchManagementRequirementIndicator_XCHPF STRING,
  PackagingMaterialType_VHART STRING,
  MaximumLevel_ByVolume_FUELG NUMERIC,
  StackingFactor_STFAK INT,
  MaterialGroup_PackagingMaterials_MAGRV STRING,
  AuthorizationGroup_BEGRU STRING,
  ValidFromDate_DATAB DATE,
  DeletionDate_LIQDT DATE,
  SeasonYear_SAISJ STRING,
  PriceBandCategory_PLGTP STRING,
  EmptiesBillOfMaterial_MLGUT STRING,
  ExternalMaterialGroup_EXTWG STRING,
  CrossPlantConfigurableMaterial_SATNR STRING,
  MaterialCategory_ATTYP STRING,
  Indicator_MaterialCanBeCoProduct_KZKUP STRING,
  Indicator_TheMaterialHasAFollowUpMaterial_KZNFM STRING,
  PricingReferenceMaterial_PMATA STRING,
  CrossPlantMaterialStatus_MSTAE STRING,
  CrossDistributionChainMaterialStatus_MSTAV STRING,
  DateFromWhichTheCrossPlantMaterialStatusIsValid_MSTDE DATE,
  DateFromWhichTheXDistrChainMaterialStatusIsValid_MSTDV DATE,
  TaxClassificationOfTheMaterial_TAKLV STRING,
  CatalogProfile_RBNRM STRING,
  MinimumRemainingShelfLife_MHDRZ NUMERIC,
  TotalShelfLife_MHDHB NUMERIC,
  StoragePercentage_MHDLP NUMERIC,
  ContentUnit_INHME STRING,
  NetContents_INHAL NUMERIC,
  ComparisonPriceUnit_VPREH NUMERIC,
  GrossContents_INHBR NUMERIC,
  QuantityConversionMethod_CMETH STRING,
  InternalObjectNumber_CUOBF STRING,
  EnvironmentallyRelevant_KZUMW STRING,
  ProductAllocationDeterminationProcedure_KOSCH STRING,
  PricingProfileForVariants_SPROF STRING,
  MaterialQualifiesForDiscountInKind_NRFHG STRING,
  ManufacturerPartNumber_MFRPN STRING,
  ManufacturerNumber_MFRNR STRING,
  NumberInventoryManagedMaterial_BMATN STRING,
  MfrPartProfile_MPROF STRING,
  UnitsOfMeasureUsage_KZWSM STRING,
  RolloutInASeason_SAITY STRING,
  DangerousGoodsIndicatorProfile_PROFL STRING,
  Indicator_HighlyViscous_IHIVI STRING,
  Indicator_InBulkLiquid_ILOOS STRING,
  LevelOfExplicitnessForSerialNumber_SERLV STRING,
  PackagingMaterialIsClosedPackaging_KZGVH STRING,
  Indicator_ApprovedBatchRecordRequired_XGCHP STRING,
  AssignEffectivityParameterValuesOverrideChangeNumbers_KZEFF STRING,
  MaterialCompletionLevel_COMPL STRING,
  PeriodIndicatorForShelfLifeExpirationDate_IPRKZ STRING,
  RoundingRuleForCalculationOfSled_RDMHD STRING,
  Indicator_ProductCompositionPrintedOnPackaging_PRZUS STRING,
  GeneralItemCategoryGroup_MTPOS_MARA STRING,
  GenericMaterialWithLogisticalVariants_BFLME STRING,
  MaterialIsLocked_MATFI STRING,
  RelevantForConfigurationManagement_CMREL STRING,
  AssortmentListType_BBTYP STRING,
  ExpirationDate_SLED_BBD STRING,
  GlobalTradeItemNumberVariant_GTIN_VARIANT STRING,
  MaterialNumberOfTheGenericMaterialInPrepackMaterials_GENNR STRING,
  ReferenceMaterialForMaterialsPackedInSameWay_RMATP STRING,
  Indicator_GlobalDataSynchronizationRelevant_GDS_RELEVANT STRING,
  AcceptanceAtOrigin_WEORA STRING,
  StandardHuType_HUTYP_DFLT STRING,
  Pilferable_PILFERABLE STRING,
  WarehouseStorageCondition_WHSTC STRING,
  WarehouseMaterialGroup_WHMATGR STRING,
  HandlingIndicator_HNDLCODE STRING,
  RelevantForHazardousSubstances_HAZMAT STRING,
  HandlingUnitType_HUTYP STRING,
  VariableTareWeight_TARE_VAR STRING,
  MaximumAllowedCapacityOfPackagingMaterial_MAXC NUMERIC,
  OvercapacityToleranceOfTheHandlingUnit_MAXC_TOL NUMERIC,
  MaximumPackingLengthOfPackagingMaterial_MAXL NUMERIC,
  MaximumPackingWidthOfPackagingMaterial_MAXB NUMERIC,
  MaximumPackingHeightOfPackagingMaterial_MAXH NUMERIC,
  UnitOfMeasureForMaximumPackingLengthwidthheight_MAXDIM_UOM STRING,
  CountryOfOriginOfMaterial_HERKL STRING,
  MaterialFreightGroup_MFRGR STRING,
  QuarantinePeriod_QQTIME NUMERIC,
  TimeUnitForQuarantinePeriod_QQTIMEUOM STRING,
  QualityInspectionGroup_QGRP STRING,
  SerialNumberProfile_SERIAL STRING,
  FormName_PS_SMARTFORM STRING,
  EwmCw_LogisticsUnitOfMeasure_LOGUNIT STRING,
  EwmCw_MaterialIsACatchWeightMaterial_CWQREL STRING,
  EwmCw_CatchWeightProfileForEnteringCwQuantity_CWQPROC STRING,
  EwmCatchWeightToleranceGroupForEwm_CWQTOLGR STRING,
  AdjustmentProfile_ADPROF STRING,
  IdForAnIntellectualProperty_CrmProduct_IPMIPPRODUCT STRING,
  VariantPriceAllowed_ForMaterialMaster_ALLOW_PMAT_IGNO STRING,
  Medium_MEDIUM STRING,
  PhysicalCommodity_COMMODITY STRING,
  Brand_BRAND_ID STRING,
  Language_SPRAS STRING,
  MaterialText_MAKTX STRING
);

INSERT INTO SSI_SAP_TO_SNOW_CLONE.REPORT.MaterialsMD
SELECT
    ...
    FROM
       SSI_SAP_TO_SNOW_CLONE.RAW.MARA AS MARA
    INNER JOIN
        SSI_SAP_TO_SNOW_CLONE.RAW.MAKT AS MAKT
        ON
