CREATE VIEW SSI_SAP_TO_SNOW_CLONE.REPORT.OneTouchOrder
AS SELECT DISTINCT
    ...
    FROM
      (
        ...
        FROM
          SSI_SAP_TO_SNOW_CLONE.RAW.vbap AS vbap,
          SSI_SAP_TO_SNOW_CLONE.RAW.vbep AS vbep,
          SSI_SAP_TO_SNOW_CLONE.RAW.lips AS lips
        WHERE
    ...
    INNER JOIN
      SSI_SAP_TO_SNOW_CLONE.RAW.vbrp AS vbrp
      ON
